...
public class Player : MonoBehaviour
{
    ...
    public bool[] skills;//Określa umiejetności: I(index 0)- atak, II(index 1)- Obrone i III-Skok(index 2)
    ...
    public int timeToRestJumping;//Określa czas odpoczynku do ponownego skoku.Określa czas potrzebny do możliwości wybrania skaku*/
    ...
    void Update()
    {
        ...
        else if (skills[0] == false && iloscSwiatla[aktualnaForma - 1] <= 1)//Ze względu na tą linijkę,trzeba ustawić mwarotści na min 1
        {
            //isDamange = false;
            aktualnaForma -= 1;
